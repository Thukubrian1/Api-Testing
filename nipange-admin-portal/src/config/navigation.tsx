 ...
 * Defines sidebar navigation structure matching CMS design
 * 
 * Depends on: navigation.types.ts, permissions.types.ts
...
export const navigationConfig: NavigationSection[] = [
    ...
    items: [
      {
        ...
        label: 'Platform Settings & Billing',
        path: '/settings',
        icon: <Icons.Settings />,
        module: Module.PLATFORM_SETTINGS,
  ...
  },
  {
    ...
    items: [
      {
        id: 'system-role',
        label: 'System Role & Reasons',
        path: '/system',
        icon: <Icons.System />,
        module: Module.SYSTEM,
        requiredPermissions: ['view_system'],
      },
      {
        id: 'messaging',
