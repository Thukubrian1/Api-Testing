...
/**
 * Minimal AuthLayout - Cleaner alternative
 */
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Access powerful tools to organize, track, and manage events.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">Real-time insights and analytics</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">Complete control over access and permissions</p>
              </div>
            </div>
